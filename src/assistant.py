...
class Assistant:
    ...
    def show_all_contacts(self):
        ...
        if not self.contacts_book.data:
            RichFormatter.print_warning("Contacts book is empty.")
            return
        
        # Use rich formatter to display contacts
        RichFormatter.display_contacts_table(self.contacts_book.data.values())
    ...
    def search_contacts(self):
        ...
        results = self.contacts_book.search(query)
        if not results:
            ...
            if 0 <= idx < len(options):
                ...
                if field == "name":
                    ...
                    if new_name and new_name != name:
                        ...
                        # Update the key in the contacts book
                        self.contacts_book.data[new_name] = record
                        del self.contacts_book.data[old_name]
    ...
    def show_upcoming_birthdays(self):
        ...
        upcoming = self.contacts_book.get_birthdays(days)
        if not upcoming:
